...
async (page) => {
  ...
  check(await page.getByRole('button', { name: 'Увеличить важность: Task b', exact: true }).isDisabled(), true, 'Guard must last 900ms')
  ...
  console.log('PASS: identity-bound highlight, 900ms reorder guard, blocked accidental clicks, timer restart, delayed saves, errors and unmount')
}
